...
router.patch("/:id/assign-advisor", authorize("admin"), clientsController.assignAdvisor);
router.patch("/:id/status", authorize("admin"), clientsController.updateClientStatus);
